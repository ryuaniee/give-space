...
@section('content')
    <div class="mx-auto max-w-4xl">
        <div class="mb-6">
            ...
            <h1 class="mt-4 text-2xl font-semibold tracking-tight text-gray-900">Tambah Campaign</h1>
            <p class="mt-1 text-sm text-gray-500">Buat campaign donasi baru.</p>
        </div>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title') }}" required
                        placeholder="Contoh: Bantu Pendidikan Anak Indonesia"
                ...
                <div>
                    <label for="end_date" class="block text-sm font-medium text-gray-900">Tanggal Selesai <span
                ...
                <div>
                    <label for="image" class="block text-sm font-medium text-gray-900">Gambar Campaign</label>
                    ...
                    <p class="mt-1 text-xs text-gray-400">JPG, PNG, WEBP. Maksimal 2 MB.</p>
                    @error('image')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="7" required
                        ...
                        class="mt-2 block w-full rounded-lg border-0 bg-gray-50 px-3 py-2.5 text-sm ring-1 ring-inset ring-gray-300 focus:bg-white focus:ring-2 focus:ring-indigo-600">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
